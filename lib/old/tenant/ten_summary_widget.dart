...
import 'package:cmsapp/old/tenant/ten_summary_details.dart';

class TenantSummaryWidget extends StatelessWidget {
  const TenantSummaryWidget({super.key});
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          SizedBox(height: 16),
          Padding(padding: EdgeInsets.all(20.0), child: TenantSummaryDetails()),
          SizedBox(height: 40),
          //Scheduled(),
        ],
      ),
